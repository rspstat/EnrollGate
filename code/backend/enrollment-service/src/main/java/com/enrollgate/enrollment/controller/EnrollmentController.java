...
import com.enrollgate.enrollment.event.EnrollEventPublisher;
...
public class EnrollmentController {
    ...
    private final EnrollEventPublisher enrollEventPublisher;
    ...
    public ResponseEntity<EnrollResponse> enroll(@PathVariable Long courseId, @AuthenticationPrincipal Long userId,
        ...
        try {
            ...
            String outcomeLabel = outcome instanceof EnrollmentOutcome.Enrolled ? "ENROLLED" : "QUEUED";
            enrollEventPublisher.publish(userId, courseId, userAgent, outcomeLabel);
            ...
            enrollEventPublisher.publish(userId, courseId, userAgent, ex.getErrorCode());
            throw ex;
        }
    }
